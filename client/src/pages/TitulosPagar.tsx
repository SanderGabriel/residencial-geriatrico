...
type Status = 'Previsto' | 'Parcial' | 'Pago' | 'Recebido' | 'Atrasado' | 'Cancelado';
...
export function TitulosPagarPage() {
  ...
  function confirmar() {
    ...
    pagarMut.mutate({
      ...
      formaPagamentoId: pagamento.formaPagamentoId
        ? Number(pagamento.formaPagamentoId)
        : null,
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-semibold">Títulos a pagar</h1>
        <p className="text-slate-500">Compromissos com fornecedores</p>
      </div>
        ...
        {pagamento && (
          <div className="space-y-3">
            <div className="text-sm bg-slate-50 p-3 rounded border border-slate-200">
              Saldo em aberto: <span className="font-semibold">{formatBRL(pagamento.saldoEmAberto)}</span>
            </div>
            <div>
